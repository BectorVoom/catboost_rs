"""Generate the BinarizedTargetMeanValue-CTR parity fixture (E13, SPEC-CTRT-07 / A2).
...
def main():
    ...
    # model.cbm is part of THIS fixture: E18/E19 reuse it as the upstream
    # BinarizedTargetMeanValue .cbm the decoder must learn to load.
    ...
    config = {
        "scenario": SCENARIO,
        "requirement": "SPEC-CTRT-07",
        "seed": 0,
        "catboost_version": "1.2.10",
        "thread_count": 1,
        "n_rows": N_ROWS,
        "description": (
            "BinarizedTargetMeanValue-CTR end-to-end isolation (E13 / A2). Categorical-ONLY feature "
            ...
            "simple_ctr=BinarizedTargetMeanValue with combinations_ctr=[] and "
            "max_ctr_complexity=1 isolates the simple BTMV type: a read-before-increment "
            "prefix over TCtrMeanHistory whose Sum is accumulated in f32. model.cbm is "
            "committed here and is reused by E18/E19 as the upstream BTMV .cbm the "
            "decoder must load. NEVER regenerated in CI."
        ),
        "params": PARAMS,
        ...
        "npy_schema": {
            ...
            "model.cbm": "upstream BTMV .cbm — the E18/E19 decoder fixture",
        },
        "note": (
