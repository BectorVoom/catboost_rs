"""Generate the WEIGHTED-training device-parity fixture, SymmetricTree arm (GDC-06/T03).
...
def main():
    ...
    config = {
        ...
        "description": (
            "Weighted-training device-parity fixture, SymmetricTree arm. 64 rows, two "
