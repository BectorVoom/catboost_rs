...
- [x] 21.5-02-PLAN.md — fuse `select_level_plain` + restructure `GrowScratch` (per-feature subtraction trick, map_init scratch, serial build removed from hot path) (D-01/D-03/D-06/D-07/D-08)
