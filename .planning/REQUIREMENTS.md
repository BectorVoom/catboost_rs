...
- [x] **GPU-03**: `rocm`/HIP backend validated on AMD hardware (wavefront-64 safe); GPU tests run on `rocm`
...
- [x] **PYAPI-01**: PyO3 + maturin per-backend wheels (`cpu` + `rocm` minimum), `abi3-py312`, Python ≥ 3.12
...
| MODEL-03 | Phase 4 (+6.6) | Complete (04-04: PredictionValuesChange + Interaction oracle-locked ≤1e-5; 06.6-06: LossFunctionChange ≤1e-5 (D-12) + PVC/Interaction generalized to non-symmetric trees ≤1e-5 (D-6.6-10)) |
...
| GPU-03 | Phase 7.6 | Complete (Phase 7.6) |
